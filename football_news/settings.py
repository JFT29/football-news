...
SECRET_KEY = 'django-insecure-(r!q*l1-7q$(aks065#ri7cks&k_rnw7-@$7swaik91yj_7vje'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "juansao-fortunio-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://juansao-fortunio-footballnews.pbp.cs.ui.ac.id",
]
